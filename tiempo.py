...
#			print("referencia: " + str(velocidadReferencia));
		...
		if time.time()-Tiempo<TiempoRespo and frenar == False:
			errorSensor = ruido;
...
#				print("bajo rapidez");
			#print("PID: " + str(velToArduino) + "\n");
			print("rapidez, referencia, tiempo, pid," + str(rapidezActual) +"," + str(velocidadReferencia) + "," + str(time.time()-Tiempo)  + "," + str(velToArduino) + ",");
...
#	print("Tiempo: " + str(time.time() - Tiempo))
	if (time.time() - Tiempo > TiempoRespo):
		#arduino.write("st$");
		#print("detener");
